...
export const RU = {
  ...
  UI: {
    ...
    /** Заголовок первого экрана. Строки заданы вручную: между ними <br> */
    heroLines: ['Мы не считаем клики', 'Мы считаем прибыль'],
    casesTitle: 'Кейсы',
...
export const EN: Bundle = {
  ...
  UI: {
    ...
    heroLines: ['We do not count clicks', 'We count profit'],
    casesTitle: 'Cases',
